...
local config = loadfile("./sasa.lua")() 
return config 
end 
_redis = load_redis()  
--------------------------------------------------------------------------------------------------------------
...
local Namebot = (bot_data:get(ban_id..'Name:Bot') or 'الصياد') 
local VENOM_Msg = { 
...
keyboard.inline_keyboard = {
{
{text = '◗الــنبــذهه◖', callback_data="/change-ghjjgyy"},{text = '◗الـسـورس◖', callback_data="/change-siusr"},
},
{
{text = '◗الابـراج◖', callback_data="/zDRGd"},{text = '◗الالـعـاب◖', callback_data="/add"},
},
{
{text = '◗مــطــور الــبــوت◖', url="http://t.me/"..sudos.UserName},
},
{
{text = '◗اضافه البوت لمجمعتك◖' ,url="t.me/"..dofile("./sasa.lua").botUserName.."?startgroup=start"},
},
}
...
send(msg.chat_id_, msg.id_,'⋆ اصدار سورس الصياد{ S:1✓}')
end
...
send(msg.chat_id_, msg.id_,'هذا الامر خاص بي فرعون فقط')
return false
end
local msg_id = msg.id_/2097152/0.5 
...
if bot_data:get(ban_id.."php_7_aza3h3" .. msg.chat_id_ .. ":" .. msg.sender_user_id_) then 
tdcli_function({ID="GetUser",user_id_=msg.sender_user_id_},function(extra,result,success)
local msa3d = bot_data:get(ban_id.."id:msa3d:ban")
if text == 'الغاء' or text == 'الغاء⋆ ' then   
send(msg.chat_id_, msg.id_,"⋆ تم الغاء الرساله للمطور")
bot_data:del(ban_id.."php_7_aza3h3" .. msg.chat_id_ .. ":" .. msg.sender_user_id_) 
return false
end 
if text then
...
print("it is Bot")
N = (bot_data:get(ban_id.."Name:Bot") or "الصياد")
...
{
{text = '◗اضافه البوت لمجمعتك◖', url = "https://t.me/"..data.username_.."?startgroup=new"},
},
}
local msg_id = msg.id_/2097152/0.5
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text="اذاعة جروبات",callback_data="php_7_aza3h1"..msg.sender_user_id_},{text="اذاعة خاص",callback_data="php_7_aza3h2"..msg.sender_user_id_}},
{{text="رساله للمطور الاساسي",callback_data="php_7_aza3h3"..msg.sender_user_id_}},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
...
if text and text:match("^احمد$") or text and text:match("^الصياد$") or text and text:match("^صياد $") then
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(extra,result,success)
tdcli_function({ID ="GetChat",chat_id_=msg.chat_id_},function(arg,dp) 
local Name1 = result.first_name_
local Name1 = Name1:gsub('"',"") 
...
sendText(1679303777,"⋆ . هناك شخص يريدك يا سيدي المطور صياد   \n⋆ الشخص  {"..Name.."}\n⋆ اسم الجروب {"..NameChat.."}\n⋆ ايدي الجروب {`"..msg.chat_id_.."`}\n⋆ رابط الجروب \n ["..LinkGroup.."] ",0,'md')
end,nil)
end,nil)
end
if text == 'احمد' or text == 'الصياد' or text == 'صياد' then
local id = '1679303777'
...
if text and text:match("^فرعون$") or text and text:match("^مبرمج$") or text and text:match("^داد$") then
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(extra,result,success)
tdcli_function({ID ="GetChat",chat_id_=msg.chat_id_},function(arg,dp) 
local Name1 = result.first_name_
local Name1 = Name1:gsub('"',"") 
...
sendText(SUDO,"⋆ . هناك شخص يريدك يا سيدي مبرمج فرعون الكبير  \n⋆ الشخص  {"..Name.."}\n⋆ اسم الجروب {"..NameChat.."}\n⋆ ايدي الجروب {`"..msg.chat_id_.."`}\n⋆ رابط الجروب \n ["..LinkGroup.."] ",0,'md')
end,nil)
end,nil)
end
if text == 'فرعون' or text == 'مبرمج' or text == 'داد' then
local id = 'SUDO'
local urrl = https.request('https://api.telegram.org/bot'..tokenget..'/getchat?chat_id='..id)
local json = JSON.decode(urrl)
local name = json.result.first_name
...
if text == "افشخوو" or text == "حفل عليه" or text == "نيكو" then 
local vBandav_Msg = { 
"  كسمك يبن الوسخه", 
" كسمسكك ",
" هنيكك",
...
function start_function(extra, result, success)
bot_data:sadd(msg.sender_user_id_..'php_7-zoaag1', result.sender_user_id_)
bot_data:sadd(result.sender_user_id_..'php_7-zoaag2', msg.sender_user_id_)
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
...
if text == "حففل" or text == "نيكو" or text == "نيك كسمو" or text == "حفل عليه" then
tdcli_function({ID="GetUser",user_id_=msg.sender_user_id_},function(extra,result,success)
local t7fel = {
...
if text == ""..(bot_data:get(ban_id..'Name:Bot') or 'الصياد').."" then  
Namebot = (bot_data:get(ban_id..'Name:Bot') or 'الصياد')
local VENOM_Msg = {
'⋆ يوه '..Namebot..' زهق منك😒',
'⋆ نعم ياعيون '..Namebot..' 😻💓',
'⋆ عايز اي من '..Namebot..' 🙄💛',
...
--------------
if text == ""..(bot_data:get(ban_id..'Name:Bot') or 'الصياد').." غادر" or text == 'غادر' and Sudo(msg) then     
...
send(msg.chat_id_, msg.id_,'⋆ نت دخلت برابط مش تعمل نفسك مهم هه .😹🚶‍♂️👍') 
end
end,nil)
else
send(msg.chat_id_, msg.id_,'⋆ تم تعطيل امر  مين ضافني') 
...
الاعمال الملائمة : أطباء، صيادلة، مدرالصياد، أخصائيو تغذية، شيف، سماسرة
...
if Text == 'php_7_aza3h1'..data.sender_user_id_ and msa3d(data) then  
...
if Text == 'php_7_aza3h2'..data.sender_user_id_ and msa3d(data) then  
...
if Text == 'php_7_aza3h3'..data.sender_user_id_ and msa3d(data) then  
bot_data:setex(ban_id.."php_7_aza3h3" .. Chat_id .. ":" .. data.sender_user_id_, 600, true) 
...
local Name_Bot = (bot_data:get(ban_id..'Name:Bot') or 'الصياد')
